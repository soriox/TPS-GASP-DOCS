...
- Use **[Firearm_BP](/weapon-system/blueprints/firearm-bp)** as a reference—it includes a fully functional setup for firearms.
...
### AutoReload (Variable)
- Available on **[Firearm_BP](/weapon-system/blueprints/firearm-bp)**.
